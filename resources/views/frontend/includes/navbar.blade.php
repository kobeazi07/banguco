        <header id="header" class="header d-flex align-items-center fixed-top">
            <div class="container-fluid container-xl position-relative d-flex align-items-center">
                ...
                <a href="index.html" class="logo d-flex align-items-center me-auto">
                    <img src="{{ asset('frontend/assets/img/logobguco.png') }}" alt="">
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('HalamanHome') }}"
                                class="{{ request()->routeIs('HalamanHome') && !request()->get('section') ? 'active' : '' }}">
                                Home
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('HalamanAbout') }}"
                                class="{{ request()->routeIs('HalamanAbout') ? 'active' : '' }}">
                                Tentang Kami
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('HalamanLayanan') }}"
                                class="{{ request()->routeIs('HalamanLayanan') ? 'active' : '' }}">
                                Layanan
                            </a>
                        </li>
                ...
                <a class="btn-getstarted bg-hijau text-white d-inline-flex align-items-center gap-2"
                    ...
                    </svg> <span class="mtt-1">Hubungi Kami</span></a>
